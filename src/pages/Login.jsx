    ...
    <div className="flex flex-col p-4 justify-center items-center">
      ...
      <form className="flex flex-col justify-center items-center">
        ...
        <div>
          ...
          <button className="bg-purple-500 text-white p-1 rounded-md mr-2" onClick={handleGoogleLogin}>Google</button>
          {/* <button className="bg-blue-500 text-white p-1 rounded-md" onClick={handleFacebookLogin}>Facebook</button> */}
        </div>
      </form>
      <p className="my-2">
        No Account? {' '}
